...
=== Download
You can downloaded the lastest version as a pdf https://github.com/razem-io/resume/releases[here] or just view it on github https://github.com/razem-io/resume/blob/master/resume.adoc[here].
